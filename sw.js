const CACHE_NAME = "mansi-shell-v4";
const SHELL = ["./","./index.html","./products.html","./css/style.css","./js/config.js","./js/data.js","./js/app.js","./data/catalog.json","./assets/brand/icon.svg"];
...
self.addEventListener("fetch", event => {
  ...
  if (request.mode === "navigate" || url.pathname.endsWith("/data/catalog.json")) {
