...
const STORE = {
  ...defaultStore,
  ...storedSettings,
  geminiApiKey: (storedSettings && storedSettings.geminiApiKey) || (typeof window !== "undefined" && window.ENV && window.ENV.GEMINI_API_KEY) || defaultStore.geminiApiKey || "AIzaSyB7UUPMmG1iNq3zKOIVi8bIbpGtX95Ywi8",
